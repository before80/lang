...
> 注意
>
> 将来可能添加以 `to` 或 `is` 后随小写字母起始的新增函数到头文件 [`<ctype.h>`]({{< ref "/c/header/ctype" >}})，故包含该头文件的程序中不应定义这些函数。
...
| 在标头 `<inttypes.h>` 定义                                 |                                                              |
| [strtoimax (C99)<br />strtoumax (C99)<br />](https://zh.cppreference.com/w/c/string/byte/strtoimax) | 将字节字符串转换成 [intmax_t]({{< ref "/c/types/integer" >}}) 或 [uintmax_t]({{< ref "/c/types/integer" >}}) (函数) |
